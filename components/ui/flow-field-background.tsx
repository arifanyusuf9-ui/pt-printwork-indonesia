...
export default function NeuralBackground({
    className,
    color = "#7AB818", // Lime (Matched to PT Printwork Theme)
    trailOpacity = 0.15,
    particleCount = 600,
    speed = 1,
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            // Assuming dark navy for this effect to match PT Printwork
            ctx.fillStyle = `rgba(13, 27, 62, ${trailOpacity})`;
    ...
    return (
        <div ref={containerRef} className={cn("relative w-full h-full bg-[#0D1B3E] overflow-hidden", className)}>
